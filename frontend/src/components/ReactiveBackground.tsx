...
const ReactiveBackground = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      const r = Math.round(
        currentColor.r + (nextColor.r - currentColor.r) * blend,
      );
      const g = Math.round(
        currentColor.g + (nextColor.g - currentColor.g) * blend,
      );
      const b = Math.round(
        currentColor.b + (nextColor.b - currentColor.b) * blend,
      );
      ...
      gradient.addColorStop(
        0.25,
        `rgba(${Math.floor(r * 0.3)}, ${Math.floor(g * 0.3)}, ${Math.floor(b * 0.3)}, 0.08)`,
      );
      gradient.addColorStop(
        0.5,
        `rgba(${Math.floor(r * 0.35)}, ${Math.floor(g * 0.35)}, ${Math.floor(b * 0.35)}, 0.05)`,
      );
      gradient.addColorStop(
        0.75,
        `rgba(${Math.floor(r * 0.3)}, ${Math.floor(g * 0.3)}, ${Math.floor(b * 0.3)}, 0.08)`,
      ...
      radialGradient.addColorStop(
        0,
        `rgba(${Math.floor(r * 0.5)}, ${Math.floor(g * 0.5)}, ${Math.floor(b * 0.5)}, 0.06)`,
      );
      radialGradient.addColorStop(
        0.5,
        `rgba(${Math.floor(r * 0.3)}, ${Math.floor(g * 0.3)}, ${Math.floor(b * 0.3)}, 0.03)`,
      );
