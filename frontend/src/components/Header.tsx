...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 pt-0 outline-none">
      <div className={`mx-auto flex items-center justify-between px-4 py-3 transition-all duration-500 outline-none border ${
        isScrolled 
        ...
        {!useLandingNavbar && (
          <span className="text-zinc-300 font-medium text-sm md:text-base hidden sm:inline">HackBelfast</span>
        )}
